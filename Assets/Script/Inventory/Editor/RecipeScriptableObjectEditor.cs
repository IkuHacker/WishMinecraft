...
public class RecipeScriptableObjectEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (recipeScriptableObject.output != null) {
            texture = recipeScriptableObject.output.visual.texture;
        }
        ...
        if (recipeScriptableObject.item_02 != null) {
            texture = recipeScriptableObject.item_02.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_12 != null) {
            texture = recipeScriptableObject.item_12.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_22 != null) {
            texture = recipeScriptableObject.item_22.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_01 != null) {
            texture = recipeScriptableObject.item_01.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_11 != null) {
            texture = recipeScriptableObject.item_11.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_21 != null) {
            texture = recipeScriptableObject.item_21.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_00 != null) {
            texture = recipeScriptableObject.item_00.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_10 != null) {
            texture = recipeScriptableObject.item_10.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
        ...
        if (recipeScriptableObject.item_20 != null) {
            texture = recipeScriptableObject.item_20.visual.texture;
        }
        GUILayout.Box(texture, GUILayout.Width(150), GUILayout.Height(150));
